...
class AudioDenoiserGUI:
    ...
    def create_widgets(self):
        ...
        ttk.Button(button_frame_output, text="📁 Browse Folders", command=self.browse_output_dir).pack(side=tk.LEFT, padx=2)
        ...
        self.results_text = tk.Text(results_frame, height=4, width=70, font=("Consolas", 9))
